...
#     return data_dict
# edge_file = "./processed_data_MDA/edge_tensor_40.pk" ## edge_index , 2-dim tensorv
# edge_index = load_pkfile(edge_file)
# deg = torch.bincount(edge_index[1], minlength=40)
...
class PNANodeEmbedding(nn.Module):
    ...
    def add_args(parser):
        ...
        group.set_defaults(gnn_emb_dim=96)
