...
class ClusterBagMultiDataset(Dataset):  ## contains clusters after mapping to centroids; merges multi datasets
    ...
    def __getitem__(self, idx):
        ...
        # print("set_id: ", set_id)
        # print("neg_sample_id: ", neg_sample_id)
        # print("neg_bag_idx: ", neg_bag_idx)
        # print("neg_bag_order: ", self.bag_orders[neg_bag_idx])
        # print("neg_set_id: ", self.bag_setids[neg_bag_idx])
        #
        # print("pos_idx1: ", pos_idx1)
        # print("pos_idx2: ", pos_idx2)
